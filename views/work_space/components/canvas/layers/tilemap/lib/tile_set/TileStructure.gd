...
func coords_to_check(relative_coord: Array, i: int, j: int) -> Dictionary:
	return {
		"North": _coords_to_check_n(relative_coord, i, j),
		"NorthEast": _coords_to_check_ne(relative_coord, i, j),
		"East": _coords_to_check_e(relative_coord, i, j),
		"SouthEast": _coords_to_check_se(relative_coord, i, j),
		"South": _coords_to_check_s(relative_coord, i, j),
		"SouthWest": _coords_to_check_sw(relative_coord, i, j),
		"West": _coords_to_check_w(relative_coord, i, j),
		"NorthWest": _coords_to_check_nw(relative_coord, i, j),
	}


func can_connect_to(another: TMM_TileStructure) -> bool:
	return id == another.id or connected_group == another.connected_group
...
func _coords_to_check_n(relative_coord: Array, i: int, j: int) -> Array:
...
func _coords_to_check_ne(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_e(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_se(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_s(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_sw(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_w(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check_nw(relative_coord: Array, i: int, j: int) -> Array:
	return _coords_to_check(
...
func _coords_to_check(colission_mask: Array, relative_coord: Array, i: int, j: int,
